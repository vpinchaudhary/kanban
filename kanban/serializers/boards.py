...
import kanban.serializers as kanban_serializers
...
class TaskSerializer(serializers.ModelSerializer):
    column = serializers.PrimaryKeyRelatedField(queryset=models.Column.objects.all())
    labels = serializers.PrimaryKeyRelatedField(
        queryset=models.Label.objects.all(), many=True, required=False
    )
...
class ColumnSerializer(BoardModelSerializer):
    board = serializers.PrimaryKeyRelatedField(queryset=models.Board.objects.all())
...
class BoardDetailSerializer(serializers.ModelSerializer):
    ...
    members = kanban_serializers.BoardMemberSerializer(many=True, read_only=True)

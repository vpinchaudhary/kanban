...
from kanban.models import Board, Task, Column, Label, Comment
from kanban.permissions import IsOwner, IsOwnerForDangerousMethods
...
from kanban.viewsets import ModelDetailViewSet
